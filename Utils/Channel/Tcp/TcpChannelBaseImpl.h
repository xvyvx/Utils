...
template<typename ProtocolTraits, const char *LoggerName> void TcpChannelBase<ProtocolTraits, LoggerName>::Close(boost::system::error_code &shutdownErr, boost::system::error_code &closeErr)
{
	if (!m_closed)
	{
